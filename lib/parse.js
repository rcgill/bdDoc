define(["build/buildControl", "bdParse"], function(bc, bdParse) {
	...
	function bdDocGen(){
		///
		// `type bdDoc.docComment
		// Array of {bdParse.token} where the each instance has a `type` property of either bdParse.symbols["tLineComment"] or bdParse.symbols["tBloclComment"].
	}
