define(["build/buildControl", "bdParse"], function(bc, bdParse) {
	...
	var
		...
		filterComments= function(
			...
			//
			// This design ultimately allows the doc comment parser to decide how to interpret the comment islands, if at all.
			...
			while(i<end){
				...
				if(commentIslands.length){
					lastNoncommentItem && (lastNoncommentItem.commentIslandsAfter = commentIslands);
